...
extension ScriptingCommandsTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__ScriptingCommandsTests = [
        ("test_multiGetScript", test_multiGetScript),
        ("test_multiSetScript", test_multiSetScript),
        ("test_scriptExistsMultiple", test_scriptExistsMultiple),
        ("test_scriptExistsSingle", test_scriptExistsSingle),
        ("test_scriptLoad", test_scriptLoad),
        ("test_scriptLoadedAfterFirstUse", test_scriptLoadedAfterFirstUse),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(ScriptingCommandsTests.__allTests__ScriptingCommandsTests),
