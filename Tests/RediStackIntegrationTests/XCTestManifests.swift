...
extension RedisConnectionPoolTests {
    ...
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__RedisConnectionPoolTests = [
        ("test_basicPooledOperation", test_basicPooledOperation),
        ("test_closedPoolDoesNothing", test_closedPoolDoesNothing),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(RedisConnectionPoolTests.__allTests__RedisConnectionPoolTests),
